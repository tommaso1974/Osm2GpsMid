...
public class MyMath {
    ...
    /**
     * Average earth radius of the WGS84 geoid in meters. The old value was
     * 6378159.81 = circumference of the earth in meters / 2 pi.
     */
    public static final double PLANET_RADIUS = 6371000.8d;
    /**
     * This constant is used as fixed point multiplier to convert latitude /
     * longitude from radians to fixpoint representation. With this multiplier,
     * one should get a resolution of 1 m at the equator.
     *
...
//	}
    ...
    /**
     * calculate the start bearing in 1/2 degree so result 90 indicates 180
     * degree.
     *
     * @param from
     * @param to
    ...
    /**
     * calculate the destination point if you travel from n with initial bearing
     * and dist in meters
     *
     * @param n startpoint
     ...
     * @param lat2 Latitude of second point in radians
     * @param lon2 Longitude of second point in radians
     * @return double array, with the distance in meters at [0] and the course
     * in radians at [1]
     */
