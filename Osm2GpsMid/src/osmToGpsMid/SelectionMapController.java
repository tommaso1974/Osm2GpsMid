 ...
 * org.openstreetmap.gui.jmapviewer package. It implements map moving by
 * dragging with the left mouse button, region marking by dragging with the
 * right mouse button, region selecting with double click and zooming by mouse
 * wheel.
 */
