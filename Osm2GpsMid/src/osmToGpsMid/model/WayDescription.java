...
public class WayDescription extends EntityDescription {
    ...
    public int wayWidth;
    /**
     * Up to 4 travel Modes (motorcar, bicycle, etc.) supported by this
     * WayDescription (1 bit per travel mode) The upper 4 bits equal to
     * Connection.CONNTYPE_* flags
     */
    public byte wayDescTravelModes;
    /**
     * typical speed of this WayDescription for up to MAXTRAVELMODES travel
     * modes
     */
    ...
    //Possiamo identificarlo come uno svincolo dell'autostrada
