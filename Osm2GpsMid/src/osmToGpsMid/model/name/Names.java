...
public class Names {
    ...
    private static final boolean allAddrTags = false;
    private final TreeMap<String, Name> names1;
    private final TreeMap<String, Name> housenumbers1;
    private final TreeSet<Name> canons;
    private final TreeSet<Name> wordCanons;
    private final TreeSet<Name> wholeWordCanons;
    private final TreeSet<Name> houseNumberCanons;

    public Names() {
        names1 = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
        housenumbers1 = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
        canons = new TreeSet<>(new CaononComperator());
        wordCanons = new TreeSet<>(new CaononComperator());
        wholeWordCanons = new TreeSet<>(new CaononComperator());
        houseNumberCanons = new TreeSet<>(new CaononComperator());
    }
