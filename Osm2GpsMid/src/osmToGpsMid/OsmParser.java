 ...
 *
 * Copyright (C) 2007 Harald Mueller Copyright (C) 2010 Kai Krueger
 */
package osmToGpsMid;
...
public abstract class OsmParser {
     ...
     * Print memory usage.
     *
     * @param numberOfGarbageLoops Number of times to call the garbage colector
     * and print the memory usage again.
     */
