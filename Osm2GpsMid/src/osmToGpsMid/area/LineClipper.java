 ...
 * @author Steve Ratcliffe
 * @see <a
 * href="http://www.skytopia.com/project/articles/compsci/clipping.html">A very
 * clear explaination of the Liang-Barsky algorithm</a>
 */
public class LineClipper {

    /**
     * Clips a polyline by the given bounding box. This may produce several
     * separate lines if the line meanders in and out of the box. This will work
     * even if no point is actually inside the box.
     *
     ...
     * this is expected to be the normal case. If clipping is needed then an
     * array of point lists is returned.
     */
    ...
    /**
     * A straight forward implementation of the Liang-Barsky algorithm as
     * described in the referenced web page.
     *
     * @param a The clipping area.
     * @param ends The start and end of the line the contents of this will be
     * changed if the line is clipped to contain the new start and end points. A
     * point that was inside the box will not be changed.
     * @return An array of the new start and end points if any of the line is
     * within the box. If the line is wholly outside then null is returned. If a
     * point is within the box then the same coordinate object will be returned
     * as was passed in.
     * @see <a
     * href="http://www.skytopia.com/project/articles/compsci/clipping.html">Liang-Barsky
     * algorithm</a>
     */
