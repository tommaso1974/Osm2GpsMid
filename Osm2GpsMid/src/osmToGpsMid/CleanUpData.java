...
import osmToGpsMid.model.Hash;
import osmToGpsMid.model.Node;
import osmToGpsMid.model.Storage;
...
public class CleanUpData {
    ...
    /**
     * Replaces all duplicate nodes in the ways which use them. Uses the
     * replaceNodes HashMap for this.
     */
    ...
    private void removeEmptyWays() {
        /**
         * At this point, the area triangulation should have happened that might
         * reference empty ways. Also the tag information for area POIs (whos
         * ways has no type) should have been copied over too. So it should be
         * safe to remove all ways (and in the second step free the nodes) of
