...
/**
 *
 * Store Constants for Configuration and Object types. Node types < 50 are
 * named, node types >= 50 are decorated with a image.
 */
package osmToGpsMid;
...
public class Constants {
     ...
     */
    /**
     * minimum distances to set the is_in name to the next city to get the
     * minimum distance use: <code>MAX_DIST_CITY[node.getType(null)]</code>
     */
